# Contributing to can-observable-decorators

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/phillipskevin/can-observable-decorators) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-observable-decorators, you can start by going to its [fork page](https://github.com/phillipskevin/can-observable-decorators/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-observable-decorators
```
